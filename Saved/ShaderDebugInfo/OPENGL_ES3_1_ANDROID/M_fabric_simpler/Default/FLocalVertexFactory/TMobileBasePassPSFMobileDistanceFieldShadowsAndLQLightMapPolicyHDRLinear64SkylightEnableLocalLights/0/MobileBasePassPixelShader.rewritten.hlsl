...
cbuffer Material {
  const float4 Material_PreshaderBuffer[19];
...
#line 331 "/Engine/Private/Common.ush"
...
#line 2719 "/Engine/Generated/Material.ush"
min16float3 CustomExpression0(FMaterialPixelParameters Parameters, min16float3 In1, min16float3 In2) {
  return max(In1, In2);
}


#line 2802 "/Engine/Generated/Material.ush"
min16float3 GetMaterialNormalRaw(FPixelMaterialInputs PixelMaterialInputs) {
  return PixelMaterialInputs.Normal;
}


#line 2807 "/Engine/Generated/Material.ush"
...
#line 2844 "/Engine/Generated/Material.ush"
...
#line 2992 "/Engine/Generated/Material.ush"
...
#line 3080 "/Engine/Generated/Material.ush"
...
#line 3085 "/Engine/Generated/Material.ush"
...
#line 3133 "/Engine/Generated/Material.ush"
...
#line 3169 "/Engine/Generated/Material.ush"
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs) {
  ...
  min16float3 Local4 = lerp(min16float3(0., 0., 1.), Local2.rgb, Material_PreshaderBuffer[0].x);
  min16float Local5 = (Local4.b + 1.);
  min16float3 Local6 = lerp(min16float3(0., 0., 1.), Local4, Material_PreshaderBuffer[0].y);
  min16float Local7 = 1.F;
  min16float4 Local8 = Texture2DSample(Material_Texture2D_1, GetMaterialSharedSampler(Material_Texture2D_1Sampler, Material_Wrap_WorldGroupSettings), Local0);
  min16float Local9 = 1.F;
  min16float3 Local10 = lerp(min16float3(0., 0., 1.), Local6, Local8.r);
  min16float2 Local11 = (Local10.rg * ((min16float2)-1.));
  min16float Local12 = dot(min16float3(Local4.rg, Local5), min16float3(Local11, Local10.b));
  min16float3 Local13 = (min16float3(Local4.rg, Local5) * ((min16float3)Local12));
  min16float3 Local14 = (((min16float3)Local5) * min16float3(Local11, Local10.b));
  min16float3 Local15 = (Local13 - Local14);
  min16float Local16 = (Local15.b + 1.);
  min16float Local17 = Local0.r;
  min16float Local18 = (Local17 * Material_PreshaderBuffer[0].z);
  min16float Local19 = Local0.g;
  min16float Local20 = (Local19 * Material_PreshaderBuffer[0].w);
  min16float2 Local21 = min16float2(Local18, Local20);
  min16float2 Local22 = (Local21 * ((min16float2)Material_PreshaderBuffer[1].x));
  min16float Local23 = 1.F;
  min16float4 Local24 = UnpackNormalMap(Texture2DSample(Material_Texture2D_2, GetMaterialSharedSampler(Material_Texture2D_2Sampler, Material_Wrap_WorldGroupSettings), Local22));
  min16float Local25 = 1.F;
  min16float3 Local26 = lerp(min16float3(0., 0., 1.), Local24.rgb, Material_PreshaderBuffer[1].y);
  min16float3 Local27 = lerp(Local26, min16float3(0., 0., 1.), Local8.r);
  min16float Local28 = (Local27.b + 1.);
  min16float2 Local29 = (Local0 * ((min16float2)Material_PreshaderBuffer[1].z));
  min16float Local30 = 1.F;
  min16float4 Local31 = UnpackNormalMap(Texture2DSample(Material_Texture2D_3, GetMaterialSharedSampler(Material_Texture2D_3Sampler, Material_Wrap_WorldGroupSettings), Local29));
  min16float Local32 = 1.F;
  min16float3 Local33 = lerp(min16float3(0., 0., 1.), Local31.rgb, Material_PreshaderBuffer[1].w);
  min16float3 Local34 = lerp(Local33, min16float3(0., 0., 1.), Local8.r);
  min16float2 Local35 = (Local34.rg * ((min16float2)-1.));
  min16float Local36 = dot(min16float3(Local27.rg, Local28), min16float3(Local35, Local34.b));
  min16float3 Local37 = (min16float3(Local27.rg, Local28) * ((min16float3)Local36));
  min16float3 Local38 = (((min16float3)Local28) * min16float3(Local35, Local34.b));
  min16float3 Local39 = (Local37 - Local38);
  min16float2 Local40 = (Local39.rg * ((min16float2)-1.));
  min16float Local41 = dot(min16float3(Local15.rg, Local16), min16float3(Local40, Local39.b));
  min16float3 Local42 = (min16float3(Local15.rg, Local16) * ((min16float3)Local41));
  min16float3 Local43 = (((min16float3)Local16) * min16float3(Local40, Local39.b));
  min16float3 Local44 = (Local42 - Local43);
  PixelMaterialInputs.Normal = Local44;
  ...
  min16float4 Local46 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_4, Material_Texture2D_4Sampler, Local22));
  min16float Local47 = 1.F;
  min16float3 Local48 = (Local46.rgb + ((min16float3)1.0E-4));
  min16float4 Local49 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4, Material_Texture2D_4Sampler, Local22, 14.));
  min16float Local50 = 1.F;
  min16float3 Local51 = (Local49.rgb + ((min16float3)1.0E-4));
  min16float3 Local52 = (Local48 / Local51);
  min16float2 Local53 = Parameters.TexCoords[1].xy;
  min16float2 Local54 = (Local53 * ((min16float2)Material_PreshaderBuffer[4].x));
  min16float2 Local55 = (Local54 + Material_PreshaderBuffer[5].xy);
  min16float Local56 = 1.F;
  min16float4 Local57 = Texture2DSample(Material_Texture2D_5, Material_Texture2D_5Sampler, Local55);
  min16float Local58 = 1.F;
  min16float3 Local59 = (Material_PreshaderBuffer[6].xyz * ((min16float3)Local57.r));
  min16float3 Local60 = (Material_PreshaderBuffer[8].xyz * ((min16float3)Local57.g));
  min16float3 Local61 = (Local59 + Local60);
  min16float3 Local62 = (Material_PreshaderBuffer[10].xyz * ((min16float3)Local57.b));
  min16float3 Local63 = (Local61 + Local62);
  min16float Local64 = (Local57.r + Local57.g);
  min16float Local65 = (Local64 + Local57.b);
  min16float Local66 = (Local65 * Material_PreshaderBuffer[10].w);
  min16float3 Local67 = lerp(Material_PreshaderBuffer[11].xyz, Local63, Local66);
  min16float3 Local68 = lerp(Local67, Material_PreshaderBuffer[13].xyz, Local8.r);
  min16float3 Local69 = (Local52 * Local68);
  min16float3 Local70 = lerp(Local69, Local68, Material_PreshaderBuffer[13].w);
  min16float3 Local71 = (Local69 * Local70);
  min16float3 Local72 = lerp(Local70, Local71, Material_PreshaderBuffer[14].x);
  min16float Local73 = 1.F;
  min16float4 Local74 = Texture2DSample(Material_Texture2D_6, GetMaterialSharedSampler(Material_Texture2D_6Sampler, Material_Wrap_WorldGroupSettings), Local22);
  min16float Local75 = 1.F;
  min16float Local76 = lerp(0.5, Local74.r, Material_PreshaderBuffer[14].y);
  min16float Local77 = (1. - Local76);
  min16float Local78 = (Local77 * 2.);
  min16float2 Local79 = (Local0 * ((min16float2)Material_PreshaderBuffer[14].z));
  min16float Local80 = 1.F;
  min16float4 Local81 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_7, GetMaterialSharedSampler(Material_Texture2D_7Sampler, Material_Wrap_WorldGroupSettings), Local79));
  min16float Local82 = 1.F;
  min16float Local83 = lerp(0.5, Local81.r, Material_PreshaderBuffer[14].w);
  min16float Local84 = (1. - Local83);
  min16float Local85 = (Local78 * Local84);
  min16float Local86 = (1. - Local85);
  min16float Local87 = (Local76 * 2.);
  min16float Local88 = (Local87 * Local83);
  min16float Local89 = ((Local76.r >= 0.5) ? Local86.r : Local88.r);
  min16float3 Local90 = (((min16float3)1.) - min16float3(min16float2(Local89, Local89), Local89));
  min16float3 Local91 = (Local90 * ((min16float3)2.));
  min16float Local92 = 1.F;
  min16float4 Local93 = Texture2DSample(Material_Texture2D_8, GetMaterialSharedSampler(Material_Texture2D_8Sampler, Material_Wrap_WorldGroupSettings), Local0);
  min16float Local94 = 1.F;
  min16float Local95 = lerp(0.5, Local93.rgba.r, Material_PreshaderBuffer[15].x);
  min16float Local96 = (1. - Local95);
  min16float3 Local97 = (Local91 * ((min16float3)Local96));
  min16float3 Local98 = (((min16float3)1.) - Local97);
  min16float3 Local99 = (min16float3(min16float2(Local89, Local89), Local89) * ((min16float3)2.));
  min16float3 Local100 = (Local99 * ((min16float3)Local95));
  min16float Local101 = ((min16float3(min16float2(Local89, Local89), Local89).r >= 0.5) ? Local98.r : Local100.r);
  min16float Local102 = ((min16float3(min16float2(Local89, Local89), Local89).g >= 0.5) ? Local98.g : Local100.g);
  min16float Local103 = ((min16float3(min16float2(Local89, Local89), Local89).b >= 0.5) ? Local98.b : Local100.b);
  min16float Local104 = (min16float3(min16float2(Local101, Local102), Local103).x * 2.);
  min16float Local105 = saturate(Local104);
  min16float Local106 = lerp(Material_PreshaderBuffer[15].y, 1., Local105);
  min16float Local107 = (Local104 - 1.);
  min16float Local108 = saturate(Local107);
  min16float Local109 = lerp(Local106, Material_PreshaderBuffer[15].z, Local108);
  min16float3 Local110 = PositiveClampedPow(Local72, ((min16float3)Local109));
  min16float3 Local111 = (((min16float3)1.) - Local110);
  min16float3 Local112 = (Local111 * ((min16float3)2.));
  min16float3 Local113 = lerp(((min16float3)0.5), min16float3(min16float2(Local101, Local102), Local103), Material_PreshaderBuffer[15].w);
  min16float3 Local114 = (((min16float3)1.) - Local113);
  min16float3 Local115 = (Local112 * Local114);
  min16float3 Local116 = (((min16float3)1.) - Local115);
  min16float3 Local117 = (Local110 * ((min16float3)2.));
  min16float3 Local118 = (Local117 * Local113);
  min16float Local119 = ((Local110.r >= 0.5) ? Local116.r : Local118.r);
  min16float Local120 = ((Local110.g >= 0.5) ? Local116.g : Local118.g);
  min16float Local121 = ((Local110.b >= 0.5) ? Local116.b : Local118.b);
  min16float3 Local122 = lerp(min16float3(min16float2(Local119, Local120), Local121), Material_PreshaderBuffer[13].xyz, Local8.r);
  min16float2 Local123 = (Local0 * ((min16float2)Material_PreshaderBuffer[16].x));
  min16float Local124 = 1.F;
  min16float4 Local125 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSample(Material_Texture2D_9, GetMaterialSharedSampler(Material_Texture2D_9Sampler, Material_Wrap_WorldGroupSettings), Local123));
  min16float Local126 = 1.F;
  min16float3 Local127 = (Local125.rgb * Local68);
  min16float3 Local128 = lerp(((min16float3)0.), Local127, Material_PreshaderBuffer[16].y);
  min16float3 Local129 = CustomExpression0(Parameters, Local122, Local128);
  min16float3 Local130 = lerp(Local129, Local122, Local8.r);
  min16float3 Local131 = PositiveClampedPow(Local130, ((min16float3)Material_PreshaderBuffer[16].z));
  min16float Local132 = lerp(Material_PreshaderBuffer[17].x, Material_PreshaderBuffer[16].w, Local8.r);
  min16float Local133 = dot(Parameters.WorldNormal, Parameters.CameraVector);
  min16float Local134 = max(0., Local133);
  min16float Local135 = (1. - Local134);
  min16float Local136 = abs(Local135);
  min16float Local137 = max(Local136, 1.0E-4);
  min16float Local138 = PositiveClampedPow(Local137, Material_PreshaderBuffer[17].y);
  min16float Local139 = (Local138 * (1. - 0.040000000000000001));
  min16float Local140 = (Local139 + 0.040000000000000001);
  min16float Local141 = (Local132 * Local140);
  min16float3 Local142 = lerp(Local130, Local131, Local141);
  min16float Local143 = lerp(Material_PreshaderBuffer[18].x, Material_PreshaderBuffer[17].w, Local74.r);
  min16float Local144 = 1.F;
  min16float4 Local145 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_10, GetMaterialSharedSampler(Material_Texture2D_10Sampler, Material_Wrap_WorldGroupSettings), Local0));
  min16float Local146 = 1.F;
  min16float Local147 = (Material_PreshaderBuffer[18].y * Local145.rgba.g);
  PixelMaterialInputs.EmissiveColor = min16float3(0., 0., 0.);
  PixelMaterialInputs.Opacity = 1.;
  PixelMaterialInputs.OpacityMask = 1.;
  PixelMaterialInputs.BaseColor = Local142;
  PixelMaterialInputs.Metallic = Material_PreshaderBuffer[17].z;
  PixelMaterialInputs.Specular = Local143;
  PixelMaterialInputs.Roughness = Local147;
  PixelMaterialInputs.Anisotropy = 0.;
  PixelMaterialInputs.Normal = Local44;
  PixelMaterialInputs.Tangent = min16float3(0., 0., 1.);
  PixelMaterialInputs.Subsurface = 0;
  PixelMaterialInputs.AmbientOcclusion = Local145.rgba.r;
...
#line 3299 "/Engine/Generated/Material.ush"
...
void Main(FVertexFactoryInterpolantsVSToPS Interpolants, FSharedMobileBasePassInterpolants BasePassInterpolants, in float4 SvPosition : SV_Position, in bool bIsFrontFace : SV_IsFrontFace, out min16float4 OutColor : SV_Target0, out float OutSceneDepthAux : SV_Target1) {
  ...
  bool bApplySkyLighting = !(1 && 1) || NoL == 0;
