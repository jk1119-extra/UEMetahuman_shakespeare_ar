...
#line 3 "/Engine/Generated/UniformBuffers/Bones.ush"
cbuffer Bones {
  const float3x4 Bones_BoneMatrices[256];
}
#line 3 "/Engine/Generated/UniformBuffers/Material.ush"
cbuffer Material {
  const float4 Material_PreshaderBuffer[39];
...
FThreeBandSHVector SHBasisFunction3(min16float3 InputVector) {
  ...
  Result.V0.x = 0.282094985F;
  Result.V0.y = -0.488602996F * InputVector.y;
  Result.V0.z = 0.488602996F * InputVector.z;
  Result.V0.w = -0.488602996F * InputVector.x;
  min16float3 VectorSquared = InputVector * InputVector;
  Result.V1.x = 1.09254801F * InputVector.x * InputVector.y;
  Result.V1.y = -1.09254801F * InputVector.y * InputVector.z;
  Result.V1.z = 0.315391988F * (3.F * VectorSquared.z - 1.F);
  Result.V1.w = -1.09254801F * InputVector.x * InputVector.z;
  Result.V2 = 0.546274006F * (VectorSquared.x - VectorSquared.y);
  return Result;
}
...
#line 680 "/Engine/Generated/Material.ush"
...
#line 2752 "/Engine/Generated/Material.ush"
min16float3 GetBentNormal0(inout FMaterialPixelParameters Parameters) {
  min16float2 Local145 = Parameters.TexCoords[0].xy;
  min16float Local146 = 1.F;
  min16float4 Local147 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_8, GetMaterialSharedSampler(Material_Texture2D_8Sampler, Material_Wrap_WorldGroupSettings), Local145));
  min16float Local148 = 1.F;
  min16float3 Local149 = (((min16float3)-0.5) + Local147.rgb);
  min16float3 Local150 = (Local149 * ((min16float3)2.));
  min16float3 Local151 = (Local150 * Material_PreshaderBuffer[36].xyz);
  min16float Local152 = (Local151.b + 1.);
  min16float Local153 = 1.F;
  min16float4 Local154 = UnpackNormalMap(Texture2DSample(Material_Texture2D_0, GetMaterialSharedSampler(Material_Texture2D_0Sampler, Material_Wrap_WorldGroupSettings), Local145));
  min16float Local155 = 1.F;
  min16float Local156 = Local145.g;
  min16float Local157 = (Local156 - 0.);
  min16float Local158 = abs(Local157);
  min16float Local159 = (Local158 * (1. / max(1.0000000000000001E-5, 0.98500001000000004)));
  min16float Local160 = (1. - Local159);
  min16float Local161 = (Local160 * (1. / max((1. - 0.89999998000000003), 1.0000000000000001E-5)));
  min16float Local162 = saturate(Local161);
  min16float3 Local163 = lerp(Material_PreshaderBuffer[3].xyz, Material_PreshaderBuffer[2].xyz, Local162);
  min16float3 Local164 = (Local154.rgb * Local163);
  min16float Local165 = (Local164.b + 1.);
  min16float4 Local166 = UnpackNormalMap(Texture2DSample(Material_Texture2D_1, GetMaterialSharedSampler(Material_Texture2D_1Sampler, Material_Wrap_WorldGroupSettings), Local145));
  min16float Local167 = 1.F;
  min16float3 Local168 = (Local166.rgb * Material_PreshaderBuffer[5].xyz);
  min16float2 Local169 = (Local168.rg * ((min16float2)-1.));
  min16float Local170 = dot(min16float3(Local164.rg, Local165), min16float3(Local169, Local168.b));
  min16float3 Local171 = (min16float3(Local164.rg, Local165) * ((min16float3)Local170));
  min16float3 Local172 = (((min16float3)Local165) * min16float3(Local169, Local168.b));
  min16float3 Local173 = (Local171 - Local172);
  min16float3 Local174 = lerp(Local164, Local173, Local162);
  min16float3 Local175 = (Local174 * Material_PreshaderBuffer[7].xyz);
  min16float3 Local176 = (Local175 * Local175);
  min16float3 Local177 = sign(Local175);
  min16float3 Local178 = (Local176 * Local177);
  min16float3 Local179 = (Local178 * Material_PreshaderBuffer[38].xyz);
  min16float2 Local180 = (Local179.rg * ((min16float2)-1.));
  min16float Local181 = dot(min16float3(Local151.rg, Local152), min16float3(Local180, Local179.b));
  min16float3 Local182 = (min16float3(Local151.rg, Local152) * ((min16float3)Local181));
  min16float3 Local183 = (((min16float3)Local152) * min16float3(Local180, Local179.b));
  min16float3 Local184 = (Local182 - Local183);
  min16float3 Local185 = lerp(min16float3(0., 0., 1.), Local184, Local162);
  min16float3 Local186 = normalize(Local185);
  return Local186;
}
...
#line 2969 "/Engine/Generated/Material.ush"
...
#line 3165 "/Engine/Generated/Material.ush"
...
#line 3170 "/Engine/Generated/Material.ush"
...
#line 3220 "/Engine/Generated/Material.ush"
...
#line 3256 "/Engine/Generated/Material.ush"
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs) {
  ...
  min16float Local4 = Local0.g;
  min16float Local5 = (Local4 - 0.);
  min16float Local6 = abs(Local5);
  min16float Local7 = (Local6 * (1. / max(1.0000000000000001E-5, 0.98500001000000004)));
  min16float Local8 = (1. - Local7);
  min16float Local9 = (Local8 * (1. / max((1. - 0.89999998000000003), 1.0000000000000001E-5)));
  min16float Local10 = saturate(Local9);
  min16float3 Local11 = lerp(Material_PreshaderBuffer[3].xyz, Material_PreshaderBuffer[2].xyz, Local10);
  min16float3 Local12 = (Local2.rgb * Local11);
  min16float Local13 = (Local12.b + 1.);
  min16float4 Local14 = UnpackNormalMap(Texture2DSample(Material_Texture2D_1, GetMaterialSharedSampler(Material_Texture2D_1Sampler, Material_Wrap_WorldGroupSettings), Local0));
  min16float Local15 = 1.F;
  min16float3 Local16 = (Local14.rgb * Material_PreshaderBuffer[5].xyz);
  min16float2 Local17 = (Local16.rg * ((min16float2)-1.));
  min16float Local18 = dot(min16float3(Local12.rg, Local13), min16float3(Local17, Local16.b));
  min16float3 Local19 = (min16float3(Local12.rg, Local13) * ((min16float3)Local18));
  min16float3 Local20 = (((min16float3)Local13) * min16float3(Local17, Local16.b));
  min16float3 Local21 = (Local19 - Local20);
  min16float3 Local22 = lerp(Local12, Local21, Local10);
  min16float3 Local23 = (Local22 * Material_PreshaderBuffer[7].xyz);
  PixelMaterialInputs.Normal = Local23;
  float3 MaterialNormal = GetMaterialNormal(Parameters, PixelMaterialInputs);
  Parameters.WorldNormal = TransformTangentNormalToWorld(Parameters.TangentToWorld, MaterialNormal);
  Parameters.WorldNormal *= Parameters.TwoSidedSign;
  Parameters.ReflectionVector = ReflectionAboutCustomWorldNormal(Parameters, Parameters.WorldNormal, false);
  Parameters.Particle.MotionBlurFade = 1.F;
  min16float Local24 = 1.F;
  min16float4 Local25 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_2, GetMaterialSharedSampler(Material_Texture2D_2Sampler, Material_Wrap_WorldGroupSettings), Local0));
  min16float Local26 = 1.F;
  min16float4 Local27 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_3, Material_Texture2D_3Sampler, Local0));
  min16float Local28 = 1.F;
  min16float Local29 = (Material_PreshaderBuffer[9].y * Local27.r);
  min16float Local30 = (Material_PreshaderBuffer[9].z * Local29);
  min16float3 Local31 = lerp(Local25.rgb, Material_PreshaderBuffer[10].xyz, Local30);
  min16float Local32 = (Local27.g * Material_PreshaderBuffer[12].x);
  min16float Local33 = (Material_PreshaderBuffer[9].z * Local32);
  min16float3 Local34 = lerp(Local31, Material_PreshaderBuffer[12].yzw, Local33);
  min16float Local35 = (Material_PreshaderBuffer[14].x * Local27.b);
  min16float Local36 = (Local35 * Material_PreshaderBuffer[14].y);
  min16float3 Local37 = lerp(Local34, Material_PreshaderBuffer[15].xyz, Local36);
  min16float Local38 = 1.F;
  min16float4 Local39 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_4, GetMaterialSharedSampler(Material_Texture2D_4Sampler, Material_Wrap_WorldGroupSettings), Local0));
  min16float Local40 = 1.F;
  min16float3 Local41 = lerp(Local37, Material_PreshaderBuffer[17].xyz, Local39.r);
  min16float3 Local42 = lerp(Local41, Material_PreshaderBuffer[19].xyz, Local39.g);
  min16float3 Local43 = lerp(Local37, Local42, Material_PreshaderBuffer[21].y);
  min16float Local44 = (Material_PreshaderBuffer[24].z * Local39.b);
  min16float3 Local45 = lerp(Local43, Material_PreshaderBuffer[25].xyz, Local44);
  min16float3 Local46 = lerp(Local45, ((min16float3)Material_PreshaderBuffer[26].x), Material_PreshaderBuffer[25].w);
  min16float Local47 = max(Local39.r, Local39.g);
  min16float Local48 = (Material_PreshaderBuffer[21].y * Local47);
  min16float Local49 = (Local48 - Local39.g);
  min16float Local50 = saturate(Local49);
  min16float Local51 = (Material_PreshaderBuffer[26].y * Local50);
  min16float Local52 = lerp(Local51, 0., Material_PreshaderBuffer[25].w);
  min16float Local53 = 1.F;
  min16float4 Local54 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_5, GetMaterialSharedSampler(Material_Texture2D_5Sampler, Material_Wrap_WorldGroupSettings), Local0));
  min16float Local55 = 1.F;
  min16float Local56 = lerp(Material_PreshaderBuffer[26].w, Material_PreshaderBuffer[26].z, Local10);
  min16float Local57 = PositiveClampedPow(Local54.r, Local56);
  min16float Local58 = (Local57 * Material_PreshaderBuffer[27].x);
  min16float Local59 = saturate(Local58);
  min16float4 Local60 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_6, GetMaterialSharedSampler(Material_Texture2D_6Sampler, Material_Wrap_WorldGroupSettings), Local0));
  min16float Local61 = 1.F;
  min16float Local62 = (Local60.r * 2.);
  min16float Local63 = lerp(Material_PreshaderBuffer[28].x, Material_PreshaderBuffer[27].w, Local60.g);
  min16float Local64 = lerp(Material_PreshaderBuffer[28].z, Material_PreshaderBuffer[28].y, Local60.g);
  min16float Local65 = lerp(Local63, Local64, Local10);
  min16float Local66 = (Local62 * Local65);
  min16float Local67 = (Material_PreshaderBuffer[28].w * Local66);
  min16float Local68 = (Material_PreshaderBuffer[29].x * Local67);
  min16float Local69 = dot(Parameters.WorldNormal, Parameters.CameraVector);
  min16float Local70 = max(0., Local69);
  min16float Local71 = (1. - Local70);
  min16float Local72 = abs(Local71);
  min16float Local73 = max(Local72, 1.0E-4);
  min16float Local74 = PositiveClampedPow(Local73, Material_PreshaderBuffer[29].y);
  min16float Local75 = (Local74 * (1. - 0.));
  min16float Local76 = (Local75 + 0.);
  min16float Local77 = lerp(Local67, Local68, Local76);
  min16float Local78 = (Material_PreshaderBuffer[29].w * Local77);
  min16float Local79 = lerp(Local77, Local78, Local30);
  min16float Local80 = lerp(Local79, Local78, Local33);
  min16float Local81 = (Local80 * Material_PreshaderBuffer[30].y);
  min16float Local82 = lerp(Local80, Local81, Local36);
  min16float Local83 = (Material_PreshaderBuffer[30].w * Local82);
  min16float Local84 = lerp(Local82, Local83, Local48);
  min16float Local85 = (Material_PreshaderBuffer[31].y * Local84);
  min16float Local86 = lerp(Local84, Local85, Local44);
  min16float Local87 = saturate(Local86);
  min16float Local88 = (Local87 * Material_PreshaderBuffer[31].z);
  min16float3 Local89 = (Local45 * ((min16float3)1.));
  min16float Local90 = dot(Local89, min16float3(0.21299999999999999, 0.71499997000000004, 0.0722));
  min16float Local91 = max(Local90, 0.040000000000000001);
  min16float Local92 = min(Local91, 0.55000000999999998);
  min16float Local93 = (Local92 + 0.089999999999999996);
  min16float Local94 = (Local93 - 0.040000000000000001);
  min16float Local95 = (Local94 / (0.55000000999999998 - 0.040000000000000001));
  min16float Local96 = (Local95 * (1. - 0.23999999));
  min16float Local97 = (Local96 + 0.23999999);
  min16float Local98 = (Material_PreshaderBuffer[31].w * Local97);
  min16float Local99 = (Local98 * Material_PreshaderBuffer[32].x);
  min16float Local100 = lerp(Local98, Local99, Local30);
  min16float Local101 = lerp(Local100, Material_PreshaderBuffer[32].y, Local44);
  min16float Local102 = lerp(Local101, Material_PreshaderBuffer[32].z, Local48);
  min16float Local103 = 1.F;
  min16float4 Local104 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_7, GetMaterialSharedSampler(Material_Texture2D_7Sampler, Material_Wrap_WorldGroupSettings), Local0));
  min16float Local105 = 1.F;
  min16float Local106 = (Local104.r * 5.);
  min16float Local107 = saturate(Local106);
  min16float Local108 = (Local104.g * 5.);
  min16float Local109 = saturate(Local108);
  min16float Local110 = (Local107 + Local109);
  min16float Local111 = (Local104.b * 5.);
  min16float Local112 = saturate(Local111);
  min16float Local113 = (Local104.a * 5.);
  min16float Local114 = saturate(Local113);
  min16float Local115 = (Local112 + Local114);
  min16float Local116 = (Local110 + Local115);
  min16float Local117 = saturate(Local116);
  min16float Local118 = (Local104.g + Local104.r);
  min16float Local119 = (Local104.a + Local104.b);
  min16float Local120 = (Local118 + Local119);
  min16float Local121 = saturate(Local120);
  min16float Local122 = lerp(Local117, Local121, Material_PreshaderBuffer[32].w);
  min16float Local123 = lerp(Local102, Material_PreshaderBuffer[33].x, Local122);
  min16float Local124 = lerp(Local102, Local123, Material_PreshaderBuffer[33].y);
  min16float Local125 = lerp(Local124, 0., Material_PreshaderBuffer[25].w);
  min16float3 Local131 = (Local23 * ((min16float3)0.5));
  min16float3 Local132 = abs(Local131);
  min16float Local133 = saturate(Local132.b);
  min16float Local134 = PositiveClampedPow(Local133, Material_PreshaderBuffer[34].y);
  min16float Local135 = PositiveClampedPow(Local73, 5.);
  min16float Local136 = (Local135 * (1. - 0.));
  min16float Local137 = (Local136 + 0.);
  min16float Local138 = lerp(Local134, 1., Local137);
  min16float Local139 = 1.F;
  min16float4 Local140 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_8, GetMaterialSharedSampler(Material_Texture2D_8Sampler, Material_Wrap_WorldGroupSettings), Local0));
  min16float Local141 = 1.F;
  min16float Local142 = PositiveClampedPow(Local140.a, Material_PreshaderBuffer[34].z);
  min16float Local143 = (Local138 * Local142);
  min16float Local144 = lerp(1., Local143, Local10);
  PixelMaterialInputs.EmissiveColor = min16float3(0., 0., 0.);
  PixelMaterialInputs.Opacity = Local125;
  PixelMaterialInputs.OpacityMask = 1.;
  PixelMaterialInputs.BaseColor = Local46;
  PixelMaterialInputs.Metallic = Local52;
  PixelMaterialInputs.Specular = Local59;
  PixelMaterialInputs.Roughness = Local88;
  PixelMaterialInputs.Anisotropy = 0.;
  PixelMaterialInputs.Normal = Local23;
  PixelMaterialInputs.Tangent = min16float3(1., 0., 0.);
  PixelMaterialInputs.Subsurface = min16float4(min16float3(1., 1., 1.), Material_PreshaderBuffer[34].x);
...
FSphericalGaussian Mul(FSphericalGaussian G0, FSphericalGaussian G1) {
  ...
  FSphericalGaussian G = { um / umLength, umLength, G0.Amplitude * G1.Amplitude * exp(umLength - Lm) };
  return G;
}


#line 165 "/Engine/Private/SphericalGaussian.ush"
FSphericalGaussian ClampedCosine_ToSphericalGaussian(float3 Normal) {
  FSphericalGaussian G;
  G.Axis = Normal;
  G.Sharpness = 2.133;
  G.Amplitude = 1.1699999999999999;
  return G;
}
...
FSphericalGaussian Hemisphere_ToSphericalGaussian(float3 Normal) {
  FSphericalGaussian G;
  G.Axis = Normal;
  G.Sharpness = 0.81000000000000005;
  G.Amplitude = 0.81000000000000005 / (1 - exp(-2 * 0.81000000000000005));
  return G;
}
...
FSphericalGaussian BentNormalAO_ToSphericalGaussian(float3 BentNormal, float AO) {
  ...
  const float HemisphereSharpness = 0.81000000000000005;
...
#line 169 "/Engine/Private/BasePassCommon.ush"
...
FShadingOcclusion ApplyBentNormal(in min16float3 CameraVector, in min16float3 WorldNormal, in float3 WorldBentNormal0, in min16float Roughness, in min16float MaterialAO) {
  ...
  Out.DiffOcclusion = saturate(Integral(DiffuseSG) * 0.42276995000000001);
  min16float3 N = WorldNormal;
...
#line 77 "/Engine/Private/GpuSkinVertexFactory.ush"
...
#line 196 "/Engine/Private/GpuSkinVertexFactory.ush"
struct FVertexFactoryInterpolantsVSToPS {
  min16float4 TangentToWorld0 : TEXCOORD10;
  min16float4 TangentToWorld2 : TEXCOORD11;
  float4 TexCoords[1] : TEXCOORD0;
};
#line 218 "/Engine/Private/GpuSkinVertexFactory.ush"
struct FVertexFactoryRayTracingInterpolants {
  FVertexFactoryInterpolantsVSToPS InterpolantsVSToPS;
};
#line 224 "/Engine/Private/GpuSkinVertexFactory.ush"
...
#line 245 "/Engine/Private/GpuSkinVertexFactory.ush"
FMaterialPixelParameters GetMaterialPixelParameters(FVertexFactoryInterpolantsVSToPS Interpolants, float4 SvPosition) {
  ...
  min16float3 TangentToWorld0 = Interpolants.TangentToWorld0.xyz;
  min16float4 TangentToWorld2 = Interpolants.TangentToWorld2;
...
#line 291 "/Engine/Private/GpuSkinVertexFactory.ush"
...
min16float4 GetPrimaryPrecomputedShadowMask(float LightmapVTPageTableResult, FVertexFactoryInterpolantsVSToPS Interpolants, FMaterialPixelParameters MaterialParameters) {
  if ((GetPrimitiveData(MaterialParameters).Flags & 2) != 0 && ResolvedView.IndirectLightingCacheShowFlag > 0.F) {
    return min16float4(IndirectLightingCache_DirectionalLightShadowing, 1, 1, 1);
  }
  return 1.F;
}
...
void GetPrecomputedIndirectLightingAndSkyLight(float LightmapVTPageTableResult, FVertexFactoryInterpolantsVSToPS Interpolants, bool bEvaluateBackface, min16float3 DiffuseDir, bool bApplySkyLighting, min16float3 SkyLightColor, out min16float3 OutDiffuseIndirectLighting, out min16float3 OutSubsurfaceIndirectLighting, out min16float OutIndirectIrradiance, out min16float3 OutWaterDiffuseIndirectLuminance) {
  ...
  OutDiffuseIndirectLighting += max(min16float3(0, 0, 0), DotSH3(PointIndirectLighting, DiffuseTransferSH));
...
void Main(FVertexFactoryInterpolantsVSToPS Interpolants, FSharedMobileBasePassInterpolants BasePassInterpolants, in float4 SvPosition : SV_Position, in bool bIsFrontFace : SV_IsFrontFace, out min16float4 OutColor : SV_Target0, out float OutSceneDepthAux : SV_Target1) {
  ...
  bool bApplySkyLighting = !(0 && 0) || NoL == 0;
