...
#line 52 "/Engine/Generated/UniformBuffers/Material.ush"
Texture2D Material_Texture2D_1;
#line 53 "/Engine/Generated/UniformBuffers/Material.ush"
...
#line 195 "/Engine/Private/MaterialTexture.ush"
...
min16float3 CustomExpression0(FMaterialPixelParameters Parameters, min16float IrisUVRadius, min16float2 UV, min16float3 LimbusUVWidth) {
...
#line 2905 "/Engine/Generated/Material.ush"
min16float3 CustomExpression1(FMaterialPixelParameters Parameters, min16float internalIoR, min16float3 normalW, min16float3 cameraW) {
  float airIoR = 1.0002899999999999;
...
#line 2924 "/Engine/Generated/Material.ush"
min16float2 CustomExpression2(FMaterialPixelParameters Parameters, min16float2 UV, min16float PupilScale, min16float PupilShiftX, min16float PupilShiftY) {
  float ShiftMask = pow(saturate(2 * ((distance(0.5F, UV) - 0.449999988F) / -0.5F)), 0.69999999999999996);
  PupilShiftX *= ShiftMask * -0.100000001F;
  PupilShiftY *= ShiftMask * 0.100000001F;
  float2 UVshifted = UV + float2(PupilShiftX, PupilShiftY);
  float2 UVcentered = UVshifted - float2(0.5F, 0.5F);
  float UVlength = length(UVcentered);
  float2 UVmax = normalize(UVcentered) * 0.5F;
  float2 UVscaled = lerp(UVmax, float2(0.F, 0.F), saturate((1.F - UVlength * 2.F) * PupilScale)) + float2(0.5F, 0.5F);
  return UVscaled;
}


#line 3033 "/Engine/Generated/Material.ush"
min16float3 GetMaterialNormalRaw(FPixelMaterialInputs PixelMaterialInputs) {
  return PixelMaterialInputs.Normal;
}


#line 3038 "/Engine/Generated/Material.ush"
...
#line 3100 "/Engine/Generated/Material.ush"
...
#line 3105 "/Engine/Generated/Material.ush"
...
#line 3152 "/Engine/Generated/Material.ush"
...
#line 3311 "/Engine/Generated/Material.ush"
...
#line 3316 "/Engine/Generated/Material.ush"
...
#line 3362 "/Engine/Generated/Material.ush"
...
#line 3398 "/Engine/Generated/Material.ush"
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs) {
  min16float2 Local0 = Parameters.TexCoords[0].xy;
  min16float Local1 = 1.F;
  min16float4 Local2 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_0, GetMaterialSharedSampler(Material_Texture2D_0Sampler, Material_Wrap_WorldGroupSettings), Local0));
  min16float Local3 = 1.F;
  min16float Local4 = (Material_PreshaderBuffer[0].x * Local2.a);
  min16float Local5 = (Local4 * 6.2831850100000004);
  min16float Local6 = cos(Local5);
  min16float Local7 = sin(Local5);
  min16float Local8 = (-1. * Local7);
  min16float2 Local9 = Local0.rg;
  min16float2 Local10 = (Local9 - min16float2(0.5, 0.5));
  min16float Local11 = dot(min16float2(Local6, Local8), Local10);
  min16float Local12 = dot(min16float2(Local7, Local6), Local10);
  min16float2 Local13 = (Local0 - min16float2(0.5, 0.5));
  min16float Local14 = dot(min16float2(Local6, Local8), Local13);
  min16float Local15 = dot(min16float2(Local7, Local6), Local13);
  min16float2 Local16 = (min16float2(Local14, Local15) + min16float2(0.5, 0.5));
  min16float Local17 = 1.F;
  min16float4 Local18 = UnpackNormalMap(Texture2DSample(Material_Texture2D_1, GetMaterialSharedSampler(Material_Texture2D_1Sampler, Material_Wrap_WorldGroupSettings), Local16));
  min16float Local19 = 1.F;
  min16float2 Local20 = (Local0 - ((min16float2)0.5));
  min16float2 Local21 = (Local20 * ((min16float2)Material_PreshaderBuffer[1].x));
  min16float2 Local22 = (Local21 - ((min16float2)0.));
  min16float Local23 = length(Local22);
  min16float Local24 = (Local23 * (1. / max(1.0000000000000001E-5, 1.)));
  min16float Local25 = (1. - Local24);
  min16float Local26 = (Local25 * (1. / max((1. - 0.49000000999999999), 1.0000000000000001E-5)));
  min16float Local27 = saturate(Local26);
  min16float Local28 = (1. - Local27);
  min16float Local29 = saturate(Local28);
  min16float2 Local30 = (Local0 * ((min16float2)Material_PreshaderBuffer[1].w));
  min16float2 Local31 = (Local30 + Material_PreshaderBuffer[3].xy);
  min16float Local32 = 1.F;
  min16float4 Local33 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSample(Material_Texture2D_2, GetMaterialSharedSampler(Material_Texture2D_2Sampler, Material_Wrap_WorldGroupSettings), Local31));
  min16float Local34 = 1.F;
  min16float Local35 = lerp(Material_PreshaderBuffer[1].y, Material_PreshaderBuffer[3].z, Local33.r);
  min16float2 Local36 = (Local20 * ((min16float2)Local35));
  min16float2 Local37 = (((min16float2)Local29) * Local36);
  min16float2 Local38 = (Local0 + Local37);
  min16float3 Local39 = CustomExpression0(Parameters, Material_PreshaderBuffer[0].w, Local38, Material_PreshaderBuffer[5].xyz);
  min16float Local40 = lerp(Material_PreshaderBuffer[5].w, 1., Local39.r);
  min16float3 Local41 = lerp(Local18.rgb, min16float3(0., 0., 1.), Local40);
  min16float Local42 = (Local41.b + 1.);
  min16float Local43 = (Material_PreshaderBuffer[6].x * Local2.a);
  min16float Local44 = (Local43 * 6.2831850100000004);
  min16float Local45 = cos(Local44);
  min16float Local46 = sin(Local44);
  min16float Local47 = (-1. * Local46);
  min16float Local48 = dot(min16float2(Local45, Local47), Local10);
  min16float Local49 = dot(min16float2(Local46, Local45), Local10);
  min16float Local50 = dot(min16float2(Local45, Local47), Local13);
  min16float Local51 = dot(min16float2(Local46, Local45), Local13);
  min16float2 Local52 = (min16float2(Local50, Local51) + min16float2(0.5, 0.5));
  min16float Local53 = 1.F;
  min16float4 Local54 = UnpackNormalMap(Texture2DSample(Material_Texture2D_3, GetMaterialSharedSampler(Material_Texture2D_3Sampler, Material_Wrap_WorldGroupSettings), Local52));
  min16float Local55 = 1.F;
  min16float Local56 = lerp(Material_PreshaderBuffer[6].z, 1., Local39.r);
  min16float3 Local57 = lerp(Local54.rgb, min16float3(0., 0., 1.), Local56);
  min16float2 Local58 = (Local57.rg * ((min16float2)-1.));
  min16float Local59 = dot(min16float3(Local41.rg, Local42), min16float3(Local58, Local57.b));
  min16float3 Local60 = (min16float3(Local41.rg, Local42) * ((min16float3)Local59));
  min16float3 Local61 = (((min16float3)Local42) * min16float3(Local58, Local57.b));
  min16float3 Local62 = (Local60 - Local61);
  PixelMaterialInputs.Normal = Local62;
  float3 MaterialNormal = GetMaterialNormal(Parameters, PixelMaterialInputs);
  Parameters.WorldNormal = TransformTangentNormalToWorld(Parameters.TangentToWorld, MaterialNormal);
  Parameters.WorldNormal *= Parameters.TwoSidedSign;
  Parameters.ReflectionVector = ReflectionAboutCustomWorldNormal(Parameters, Parameters.WorldNormal, false);
  Parameters.Particle.MotionBlurFade = 1.F;
  min16float Local63 = length(Local20);
  min16float Local64 = (Local63 * Material_PreshaderBuffer[8].z);
  min16float Local65 = (1. - Local64);
  min16float Local66 = (Local65 * Material_PreshaderBuffer[9].z);
  min16float Local67 = saturate(Local66);
  min16float3 Local68 = lerp(Material_PreshaderBuffer[10].xyz, ((min16float3)1.), Local67);
  min16float3 Local69 = mul(min16float3(1., 0., 0.), Parameters.TangentToWorld);
  min16float3 Local70 = normalize(Local69);
  min16float Local71 = 1.F;
  min16float4 Local72 = UnpackNormalMap(Texture2DSample(Material_Texture2D_4, GetMaterialSharedSampler(Material_Texture2D_4Sampler, Material_Wrap_WorldGroupSettings), Local0));
  min16float Local73 = 1.F;
  min16float3 Local74 = mul(Local72.rgb, Parameters.TangentToWorld);
  min16float Local75 = dot(Local70, Local74);
  min16float3 Local76 = (((min16float3)Local75) * Local74);
  min16float3 Local77 = (Local70 - Local76);
  min16float3 Local78 = normalize(Local77);
  min16float3 Local79 = CustomExpression1(Parameters, Material_PreshaderBuffer[11].x, Parameters.WorldNormal, Parameters.CameraVector);
  min16float Local80 = 1.F;
  min16float4 Local81 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_0, GetMaterialSharedSampler(Material_Texture2D_0Sampler, Material_Wrap_WorldGroupSettings), Material_PreshaderBuffer[11].zw));
  min16float Local82 = 1.F;
  min16float3 Local83 = (Local2.rgb - ((min16float3)Local81.r));
  min16float3 Local84 = max(Local83, ((min16float3)0.));
  min16float3 Local85 = (Local84 * ((min16float3)Material_PreshaderBuffer[12].x));
  min16float Local86 = dot(Parameters.CameraVector, Local74);
  min16float Local87 = (Local86 * Local86);
  min16float Local88 = lerp(0.32499999000000002, 1., Local87);
  min16float3 Local89 = (Local85 / ((min16float3)Local88));
  min16float3 Local90 = (Local79 * Local89);
  min16float Local91 = dot(Local78, Local90);
  min16float3 Local92 = cross(Local78, Local74);
  min16float Local93 = dot(Local92, Local90);
  min16float2 Local94 = (Material_PreshaderBuffer[12].yz * min16float2(Local91, Local93));
  min16float2 Local95 = (Local94 + Local38);
  min16float2 Local96 = lerp(Local38, Local95, Local39.xy.r);
  min16float2 Local97 = (Local96 - ((min16float2)0.5));
  min16float2 Local98 = (((min16float2)Material_PreshaderBuffer[12].w) * Local97);
  min16float2 Local99 = (Local98 + ((min16float2)0.5));
  min16float2 Local100 = CustomExpression2(Parameters, Local99, Material_PreshaderBuffer[13].x, Material_PreshaderBuffer[13].y, Material_PreshaderBuffer[13].z);
  min16float2 Local101 = (Local100 * ((min16float2)Material_PreshaderBuffer[14].x));
  min16float2 Local102 = (Local101 + ((min16float2)0.5));
  min16float2 Local103 = (Local102 - ((min16float2)Material_PreshaderBuffer[14].y));
  min16float2 Local104 = (Local103 * ((min16float2)1.));
  min16float2 Local105 = (Local104 - ((min16float2)0.5));
  min16float Local106 = length(Local105);
  min16float Local107 = (Local106 * Material_PreshaderBuffer[15].x);
  min16float Local108 = (1. - Local107);
  min16float Local109 = (Local108 * Material_PreshaderBuffer[16].x);
  min16float Local110 = saturate(Local109);
  min16float3 Local111 = (((min16float3)Local110) * Material_PreshaderBuffer[18].xyz);
  min16float Local112 = 1.F;
  min16float4 Local113 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_5, GetMaterialSharedSampler(Material_Texture2D_5Sampler, Material_Wrap_WorldGroupSettings), Local16));
  min16float Local114 = 1.F;
  min16float3 Local115 = PositiveClampedPow(Local113.rgb, ((min16float3)Material_PreshaderBuffer[18].w));
  min16float3 Local116 = (Local115 * ((min16float3)Material_PreshaderBuffer[19].z));
  min16float Local117 = 1.F;
  min16float4 Local118 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_6, GetMaterialSharedSampler(Material_Texture2D_6Sampler, Material_Clamp_WorldGroupSettings), Material_PreshaderBuffer[20].yz));
  min16float Local119 = 1.F;
  min16float3 Local120 = (Local116 * Local118.rgb);
  min16float3 Local121 = (Local120 * Material_PreshaderBuffer[22].xyz);
  min16float3 Local122 = lerp(Local120, Local121, Local39.g);
  min16float Local123 = 1.F;
  min16float4 Local124 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_7, GetMaterialSharedSampler(Material_Texture2D_7Sampler, Material_Wrap_WorldGroupSettings), Local52));
  min16float Local125 = 1.F;
  min16float3 Local126 = PositiveClampedPow(Local124.rgb, ((min16float3)Material_PreshaderBuffer[22].w));
  min16float3 Local127 = (Local122 * Local126);
  min16float Local128 = 1.F;
  min16float4 Local129 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_8, GetMaterialSharedSampler(Material_Texture2D_8Sampler, Material_Clamp_WorldGroupSettings), Material_PreshaderBuffer[24].zw));
  min16float Local130 = 1.F;
  min16float Local131 = 1.F;
  min16float4 Local132 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_8, GetMaterialSharedSampler(Material_Texture2D_8Sampler, Material_Clamp_WorldGroupSettings), Material_PreshaderBuffer[25].xy));
  min16float Local133 = 1.F;
  min16float Local134 = 1.F;
  min16float4 Local135 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_9, GetMaterialSharedSampler(Material_Texture2D_9Sampler, Material_Wrap_WorldGroupSettings), Local104));
  min16float Local136 = 1.F;
  min16float Local137 = (Local135.r * 2.);
  min16float Local138 = saturate(Local137);
  min16float3 Local139 = lerp(Local129.rgb, Local132.rgb, Local138);
  min16float Local140 = 1.F;
  min16float4 Local141 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_8, GetMaterialSharedSampler(Material_Texture2D_8Sampler, Material_Clamp_WorldGroupSettings), Material_PreshaderBuffer[26].xy));
  min16float Local142 = 1.F;
  min16float Local143 = (Local137 - 1.);
  min16float Local144 = saturate(Local143);
  min16float3 Local145 = lerp(Local139, Local141.rgb, Local144);
  min16float Local146 = dot(Local145, min16float3(0.30000000999999998, 0.58999997000000004, 0.11));
  min16float Local147 = lerp(-1., 1., Local135.r);
  min16float Local148 = (Local147 * Material_PreshaderBuffer[26].z);
  min16float3 Local149 = lerp(Local145, ((min16float3)Local146), Local148);
  min16float Local150 = 1.F;
  min16float4 Local151 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_8, GetMaterialSharedSampler(Material_Texture2D_8Sampler, Material_Clamp_WorldGroupSettings), Material_PreshaderBuffer[28].xy));
  min16float Local152 = 1.F;
  min16float Local153 = 1.F;
  min16float4 Local154 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_8, GetMaterialSharedSampler(Material_Texture2D_8Sampler, Material_Clamp_WorldGroupSettings), Material_PreshaderBuffer[28].zw));
  min16float Local155 = 1.F;
  min16float3 Local156 = lerp(Local151.rgb, Local154.rgb, Local138);
  min16float Local157 = 1.F;
  min16float4 Local158 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_8, GetMaterialSharedSampler(Material_Texture2D_8Sampler, Material_Clamp_WorldGroupSettings), Material_PreshaderBuffer[29].zw));
  min16float Local159 = 1.F;
  min16float3 Local160 = lerp(Local156, Local158.rgb, Local144);
  min16float Local161 = dot(Local160, min16float3(0.30000000999999998, 0.58999997000000004, 0.11));
  min16float3 Local162 = lerp(Local160, ((min16float3)Local161), Local148);
  min16float Local163 = (1. - Local135.b);
  min16float Local164 = smoothstep(Material_PreshaderBuffer[30].w, Material_PreshaderBuffer[30].z, Local163);
  min16float3 Local165 = lerp(Local149, Local162, Local164);
  min16float Local166 = (1. - Local135.r);
  min16float Local167 = smoothstep(Material_PreshaderBuffer[30].w, Material_PreshaderBuffer[30].z, Local166);
  min16float3 Local168 = lerp(Local149, Local162, Local167);
  min16float3 Local169 = lerp(Local165, Local168, Material_PreshaderBuffer[31].x);
  min16float3 Local170 = (Local169 * ((min16float3)Local135.a));
  min16float3 Local171 = (Local170 * ((min16float3)Local135.g));
  min16float3 Local172 = lerp(Local170, Local171, Material_PreshaderBuffer[31].y);
  min16float3 Local173 = PositiveClampedPow(Local172, ((min16float3)Material_PreshaderBuffer[31].w));
  min16float2 Local174 = (Local104 + ((min16float2)-0.5));
  min16float2 Local175 = (Local174 - ((min16float2)0.));
  min16float Local176 = length(Local175);
  min16float Local177 = smoothstep(0.27500001000000002, 0.5, Local176);
  min16float3 Local178 = lerp(Local172, Local173, Local177);
  min16float3 Local179 = (Local178 * ((min16float3)Material_PreshaderBuffer[32].x));
  min16float Local180 = dot(Local179, min16float3(0.30000000999999998, 0.58999997000000004, 0.11));
  min16float3 Local181 = lerp(Local179, ((min16float3)Local180), Material_PreshaderBuffer[32].w);
  min16float3 Local182 = lerp(Local127, Local181, Local39.r);
  min16float3 Local183 = (Local111 + Local182);
  min16float3 Local184 = (Local68 * Local183);
  min16float Local185 = lerp(Material_PreshaderBuffer[33].y, Material_PreshaderBuffer[33].x, Local39.r);
  min16float Local186 = lerp(Material_PreshaderBuffer[33].w, Material_PreshaderBuffer[33].z, Local39.r);
  ...
  PixelMaterialInputs.Specular = Local185;
  PixelMaterialInputs.Roughness = Local186;
...
#line 118 "/Engine/Private/LocalVertexFactoryCommon.ush"
...
min16float4 GetPrimaryPrecomputedShadowMask(float LightmapVTPageTableResult, FVertexFactoryInterpolantsVSToPS Interpolants, FMaterialPixelParameters MaterialParameters) {
  ...
  min16float4 DistanceField = Texture2DSample(LightmapResourceCluster_StaticShadowTexture, LightmapResourceCluster_StaticShadowTextureSampler, ShadowMapCoordinate);
  float4 InvUniformPenumbraSizes = PrecomputedLightingBuffer_InvUniformPenumbraSizes;
  float4 DistanceFieldBias = -0.5F * InvUniformPenumbraSizes + 0.5F;
  min16float4 ShadowFactor = saturate(DistanceField * InvUniformPenumbraSizes + DistanceFieldBias);
  return PrecomputedLightingBuffer_StaticShadowMapMasks * ShadowFactor * ShadowFactor;
  return 1.F;
}
